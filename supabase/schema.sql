...
-- ── AJOUT EXERCICE : SWOT LUXAIR (2026-09-25) ────────────────────────────────
-- Application 1 (matériel de cours "Marketing1" de Jeff) ajoutée comme exercice
-- supplémentaire de la section "Analyser son environnement avec la méthode SWOT"
-- (chapitre "Marketing 1 : L'étude de marché"), après l'exercice McDonald's existant.
-- Ajout de l'exercice "Application 1 — Analyse SWOT de Luxair" dans la section
-- "Analyser son environnement avec la méthode SWOT" (après l'exercice McDonald's existant).
insert into exercices (id, section_id, chapitre_id, titre, type, enonce, options, correction, points, ordre, parametres) values (
